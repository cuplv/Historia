...
//import edu.colorado.plv.bounder.lifestate.LifeState.{And, Exists, Forall, LSAtom, LSConstraint, LSFalse, LSImplies, LSPred, LSSpec, LSTrue, NS, Not, AbsMsg, Or}
...
//    val leafState: Set[((LSAtom, State, Loc), Expr[UninterpretedSort])] =
...
//      case ((o@Once(mt,sig,lsVars),_, _), identifier) => o -> lsVars.toArray
//    }
//
...
//      case (atom, _, _) => atom.identitySignature == target.identitySignature
//    }.map{
