...
The version of Flowdroid we used for this comparison may be found in \codej{/home/FlowDroid}.  Unfortunately, we were unable to get Flowdroid to run inside the docker container. However, the command we used is recorded in \codej{/home/notebooks/runFlowDroidCallGraph.sh}.  This command works when running via the Intellij IDE which is where we performed this experiment.
