...
The notebook \codej{RunTable2-Minimal-Resources.ipynb} will run by clearing the database and uploading the locations in the ``dataSubset'' directory.  The worker container will then process them one at a time.  
